...
//                14, 256, 1.6302684001174041, 404552, 401,
                ...
                // Elias Fano, Java 7, 200'000, old split
...
//        }
        ...
        for (FunctionInfo info : list) {
            ...
            double score = info.evaluateNanos * 10 + info.generateNanos;
            if (score > bestScore) {
                continue;
            }
            bestScore = score;
            ...
            if (info.generateNanos > last.generateNanos * 1.1) {
                continue;
            }
            last = info;
            balanced.add(info);
...
//        }
    ...
    private static void experimentalResults(int size, int loadFactor) {
        System.out.println("loadFactor " + loadFactor);
        System.out.println("leafSize, bits/key");
        System.out.println("calculated");
        double last = 10;
        for (int leafSize = 6; leafSize <= 32; leafSize++) {
