...
public class BatchTest {
    ...
    public void setup() {
        ...
        System.out.println("testpresentcount " + testpresentcount);
        System.out.println("testmixedcount " + testmixedcount);
    }
    ...
    public void testXor8() {
        ...
        if (testcount > 0)
            System.out.println("xor8 fpp " + (count - testcount) * 1.0 / testcount);
        assertTrue((mixedcount - testmixedcount) * 1.0 / testmixedcount < 2.0 / 256); // should
                                                                                      // be
                                                                                      // improbable
    ...
    public void testXor16() {
        ...
        assertEquals(mixedcount, bmixedcount);
        if (testcount > 0)
            System.out.println("fpp " + (count - testcount) * 1.0 / testcount);
        System.out.println("xor16 fpp " + (presentcount - testpresentcount) * 1.0 / testpresentcount);
        System.out.println("xor16 fpp " + (mixedcount - testmixedcount) * 1.0 / testmixedcount);
        assertTrue((mixedcount - testmixedcount) * 1.0 / testmixedcount < 2.0 / 65536); // should
                                                                                        // be
                                                                                        // improbable
